...
天下苦信息收集久矣！老师们忙于科研没有精力更新主页。这对新同学有许多的挑战！于是借助科研轮转，诞生了该项目，我们期望借助上课的同学，对各个老师实验室的信息收集，共同维护～。
...
=======
这门课的课程报告要求参考每个具体实验室，搭建科研实践传承体系，提供实验室方向介绍、论文收集、以及可以在4-8周内动手完成的模块化任务等等，方便未来同学无须实际进组就可对科研实验室快速了解和上手。如果同学们分别搭建自己导师的网站的话可能不方便维护，也不方便没有进组的同学收集信息。所以我决定搭一个统一的基座，大家在这个基础上补充各个实验室的情况。
...
### 致谢：
项目的页面demo基于(https://github.com/PKUFlyingPig/cs-self-learning.git)构建。